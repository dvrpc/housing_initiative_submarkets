...
raw_data$county <- counties


submarket_inputs_counties <- raw_data%>%
  ...
  select(county, UNITS_TOT, POP_TOT, HH_TOT, HHINC_MED, RENT_MED, TEN_RENT, TEN_OWN, VCY, HHI_U35, HHI_3575, HHI_75100, HHI_100P, HHI_150P, THREE_BR, YB_59E, YB_6099, YB_00L, UNIT_1, UNIT_2to4, UNIT_5P, HHS_1, HHS_2to4, HHS_5P)



write.csv(submarket_inputs_counties, "U:\\FY2022\\Planning\\RegionalHousingInitiative\\SubmarketAnalysis\\data\\submarket_inputs_countysummary.csv", row.names = FALSE) 
