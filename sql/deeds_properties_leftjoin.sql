...
SELECT "deeds"."PROPID", "TRANID", "DEEDTYPE", "DATE_FINAL", "MORTGAGE", "PRICE", "LSTSLPR", CAST("LSTSLDATE" AS VARCHAR) AS "LASTSLVARCHAR" FROM "twg"."twg_deeds_2021_datefinal" AS "deeds"
